  ...
  return (
    <>
      ...
      <ul className='portfolio__projects'>
        <li><a target="_blank" href="https://github.com/Burunova-Olga/how-to-learn" className="link project__link"> 
          <p className="project__text">Статичный сайт</p>
          <p className="project__text">↗</p>
        </a></li>
        <li><a target="_blank" href="https://github.com/Burunova-Olga/russian-travel" className="link project__link">
